    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/lhui/wiki/tree/master/docs/',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/lhui/wiki/tree/master/blog/',
        },
        theme: {
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/lhui/wiki',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} lihui life wiki project. Built with Docusaurus.`,
      },
      prism: {
